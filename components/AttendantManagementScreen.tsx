...
import { fetchAttendantsData } from '../services/api';
        ...
        {selectedAttendant && (
           <div className="w-full lg:w-[400px] bg-white rounded-xl border border-gray-200 shadow-xl flex flex-col overflow-hidden animate-in slide-in-from-right-4 duration-300 absolute lg:relative inset-0 lg:inset-auto z-10 lg:z-auto">
              ...
              <div className="p-6 border-t border-gray-100 bg-gray-50/50 space-y-3">
                 ...
                 <button className="w-full py-2 flex items-center justify-center gap-2 text-red-600 text-xs font-bold hover:bg-red-50 rounded-lg transition-colors">
                    <Trash2 size={14} />
                    Excluir Frentista
                 </button>
              </div>
